      ...
      <header className="h-16 border-b border-slate-800 flex items-center justify-between px-6 bg-slate-950/50 backdrop-blur sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold tracking-tight text-white">
            ...
            <span className="text-xs ml-2 font-normal text-slate-500 px-2 py-0.5 border border-slate-800 rounded-full">v1.0.1</span>
          </h1>
        </div>
        ...
        <div className="flex items-center gap-4">
           ...
           <button className="bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded-md text-sm font-medium shadow-lg shadow-emerald-900/20 transition-all">
             Export Run
           </button>
        </div>
      </header>
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              {selectedIndividual && (
                <span className={`text-xs px-2 py-1 rounded border font-mono ${
                    selectedIndividual.id === bestIndividual?.id 
              ...
              {[...population]
                ...
                <div 
                  ...
                  className={`flex items-center justify-between p-2 rounded border transition-colors cursor-pointer group ${
                      ind.id === selectedId ? 'bg-slate-800 border-slate-600' : 'bg-slate-950/50 border-slate-800/50 hover:border-slate-700'
                  }`}
                >
                  <div className="flex items-center gap-3">
